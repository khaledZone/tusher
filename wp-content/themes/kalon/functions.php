...
if ( ! defined( 'KALON_THEME_VERSION' ) && ! defined( 'KALON_THEME_NAME' ) && ! defined( 'KALON_THEME_TEXTDOMAIN' ) ) {
	$theme_data = wp_get_theme();	
	define( 'KALON_THEME_VERSION', $theme_data->get( 'Version' ) );
    define( 'KALON_THEME_NAME', $theme_data->get( 'Name' ) );
    define( 'KALON_THEME_TEXTDOMAIN', $theme_data->get( 'TextDomain' ) );
}
        ...
        <div class="welcome-message notice notice-info">
            <div class="notice-wrapper">
                <div class="notice-text">
                    ...
                    <p><?php printf( __( '%1$s is now installed and ready to use. Click below to see theme documentation, plugins to install and other details to get started.', 'kalon' ), $name ) ; ?></p>
...
if( ! function_exists( 'kalon_restore_admin_notice' ) ) :
/**
 * Restoring admin notice on theme switch
 */
function kalon_restore_admin_notice(){
    update_option( 'kalon_admin_notice', false );
}
endif;
add_action( 'after_switch_theme', 'kalon_restore_admin_notice' );
