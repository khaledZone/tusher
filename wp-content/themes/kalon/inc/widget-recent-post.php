...
// register Kalon_Recent_Post widget
function kalon_register_recent_post_widget() {
    register_widget( 'Kalon_Recent_Post' );
}
add_action( 'widgets_init', 'kalon_register_recent_post_widget' );
 
 /**
 * Adds Kalon_Recent_Post widget.
 */
class Kalon_Recent_Post extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'kalon_recent_post', // Base ID
			__( 'RARA: Recent Post', 'kalon' ), // Name
			array( 'description' => __( 'A Recent Post Widget', 'kalon' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
        ...
        $title      = ! empty( $instance['title'] ) ? strip_tags( $instance['title'] ) : __( 'Recent Posts', 'kalon' );
                    ...
                    <article class="post">
                        ...
                        <header class="entry-header">
                                    ...
                                    <?php if( $show_date ){ ?>
                                        ...
                                        <?php echo get_the_date('F jS, Y'); ?></time></a></span>
                                    <?php } ?>
                                    </div>
                         </header>                       
                    </article>        
	...
	public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title', 'kalon' ); ?></label> 
            <input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
		</p>
        
        <p>
            <label for="<?php echo $this->get_field_id( 'num_post' ); ?>"><?php _e( 'Number of Posts', 'kalon' ); ?></label> 
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id( 'show_thumbnail' ); ?>"><?php _e( 'Show Post Thumbnail', 'kalon' ); ?></label>
		</p>
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id( 'show_postdate' ); ?>"><?php _e( 'Show Post Date', 'kalon' ); ?></label>
		</p>
		<?php 
	}
	...
	public function update( $new_instance, $old_instance ) {
        ...
        $instance['title']          = ! empty( $new_instance['title'] ) ? strip_tags( $new_instance['title'] ) : __( 'Recent Posts', 'kalon' );
